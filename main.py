...
x = datetime.datetime(2021, 5, 29, 18, 25, 30)
y = datetime.datetime(2021, 5, 22, 8, 21, 10)

# returns a timedelta object
z = x - y
print('Difference between Fitness Start Date and End Date: ', z)
...
if total > 400:
    ...
    print("\nYou have built up endurance. Congratulations")# string is initialized
